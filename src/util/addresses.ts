...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.MAGMA_TESTNET]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.MAGMA_TESTNET].v3CoreFactoryAddress,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  // TODO: Gnosis + Moonbeam contracts to be deployed
  [ChainId.MAGMA_TESTNET]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.MAGMA_TESTNET].quoterAddress,
};
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  // TODO: Gnosis + Moonbeam contracts to be deployed
  [ChainId.MAGMA_TESTNET]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.MAGMA_TESTNET].multicallAddress,
};
